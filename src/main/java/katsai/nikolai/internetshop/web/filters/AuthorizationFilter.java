package katsai.nikolai.internetshop.web.filters;
...
import static katsai.nikolai.internetshop.models.Role.RoleName.ADMIN;
import static katsai.nikolai.internetshop.models.Role.RoleName.USER;
...
public class AuthorizationFilter implements Filter {
    ...
    private boolean verifyRole(User user, Role.RoleName roleName) {
        return user.getRoles().stream().anyMatch(role -> role.getRoleName()
